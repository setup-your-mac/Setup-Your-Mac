...
stepRosetta='{  "listitem": "Rosetta",
                ...
                "trigger_list": [
                    { "trigger": "rosettaInstall","validation": "None" },
                    { "trigger": "rosetta","validation": "Local" }
                ]
            },'
...
stepAdobeReader='{
                    ...
                    "trigger_list": [{ "trigger": "adobeAcrobatReader","validation": "/Applications/Adobe Acrobat Reader.app/Contents/Info.plist" }]
                },'
...
stepGoogleChrome='{
                    ...
                    "trigger_list": [{ "trigger": "googleChrome","validation": "/Applications/Google Chrome.app/Contents/Info.plist" }]
                },'

stepFileVault='{    "listitem": "FileVault Disk Encryption",
                    ...
                    "trigger_list": [{ "trigger": "filevault","validation": "Local" }]
                },'
...
stepMicrosoftOffice='{
                ...
                "trigger_list": [
                    { "trigger": "microsoftOffice365","validation": "/Applications/Microsoft Outlook.app/Contents/Info.plist" },
                    { "trigger": "symvMicrosoftOffice365","validation": "Remote" }
                ]
            },'
...
stepMicrosoftTeams='{
                ...
                "trigger_list": [{ "trigger": "microsoftTeams","validation": "/Applications/Microsoft Teams.app/Contents/Info.plist" }]
            },'
...
stepPaloAlto='{
                ...
                "trigger_list": [{ "trigger": "globalProtect","validation": "/Applications/GlobalProtect.app/Contents/Info.plist" }]
            },
            {
                ...
                "trigger_list": [{ "trigger": "symvGlobalProtect","validation": "Remote" }]
            },'
stepSophos='{   "listitem": "Sophos Endpoint",
                ...
                "trigger_list": [{ "trigger": "sophosEndpoint","validation": "/Applications/Sophos/Sophos Endpoint.app/Contents/Info.plist" }]
            },
            {   "listitem": "Sophos Endpoint Services (Remote)",
                ...
                "trigger_list": [{ "trigger": "symvSophosEndpointRTS", "validation": "Remote" }]
            },'
...
stepFinalConfig='{
                    ...
                    "trigger_list": [
                        { "trigger": "finalConfiguration","validation": "None" },
                        { "trigger": "reconAtReboot","validation": "None" }
                    ]
                },'
...
stepRecon='{
                ...
                "trigger_list": [{ "trigger": "recon","validation": "recon" }]
            }'

## List out what the policyJSON will eventually include
stepRequired="${stepRosetta}${stepSophos}${stepPaloAlto}"
stepRecommended="${stepRequired}${stepMicrosoftOffice}${stepMicrosoftTeams}"
stepComplete="${stepRecommended}${stepAdobeReader}${stepGoogleChrome}"

## Always final steps
stepFinal="${stepFinalConfig}${stepRecon}"
...
function policyJSONConfiguration() {
    ...
    case ${symConfiguration} in
        "Recommended" ) policyJSON="${policyJSON}${stepRecommended}${stepFinal}]}" ;;
        "Complete" ) policyJSON="${policyJSON}${stepComplete}${stepFinal}]}" ;;
        * ) # Catch-all (i.e., used when `welcomeDialog` is set to `video` or `false`)
            policyJSON="${policyJSON}${stepRequired}${stepFinal}]}" ;;
    esac
