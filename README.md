...
[<img align="right" alt="Setup Your Mac (1.16.2b2)" src="images/SYM_icon_255.png" width="128" />](https://github.com/setup-your-mac/Setup-Your-Mac/wiki)

# Setup Your Mac (1.16.2b2) <br> with SYM-Helper (1.3.1) <br> via swiftDialog (3.1.0)
...
> Optimized to leverage SYM-Helper (1.3.1), Setup Your Mac (1.16.2b2) offers full support of swiftDialog (3.1.0).
