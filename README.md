...
# Setup Your Mac (1.16.2b1) <br> with SYM-Helper (1.3.1) <br> via swiftDialog (3.1.0)
...
> Optimized to leverage SYM-Helper (1.3.1), Setup Your Mac (1.16.2b1) offers full support of swiftDialog (3.1.0).
